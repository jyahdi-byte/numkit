all: test_solvers.exe omega_sweep.exe red_black_sweep.exe cg_sweep.exe pcg_sweep.exe heat.exe validate.exe test_mt.exe bench_mt.exe test_omega_auto.exe test_grid.exe test_jacobi.exe test_rb_mt.exe test_grid3d.exe test_jacobi3d.exe test_gauss_seidel3d.exe test_sor3d.exe test_solvers3d.exe test_slice_grid3d.exe
...
test_gauss_seidel3d.exe: include/grid.hpp include/gauss_seidel.hpp tests/test_gauss_seidel3d.cpp
	g++ -std=c++20 -Wall -I include tests/test_gauss_seidel3d.cpp -o test_gauss_seidel3d.exe

test_sor3d.exe: include/grid.hpp include/sor.hpp tests/test_sor3d.cpp
	g++ -std=c++20 -Wall -I include tests/test_sor3d.cpp -o test_sor3d.exe
